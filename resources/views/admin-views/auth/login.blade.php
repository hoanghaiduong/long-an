                                ...
                                <div class="row p-2">
                                    ...
                                    <div class="col-6 input-icons" class="bg-white rounded">
                                        <a onclick="javascript:re_captcha();">
                                            <img src="{{ URL('/auth/captcha/'.rand().'?captcha_session_id=default_recaptcha_id_'.$role.'_login') }}" class="input-field w-90 h-75" id="default_recaptcha_id">
...
@else
    ...
    <script type="text/javascript">
        var captchaURL = "{{ URL('/auth/captcha/'.rand().'?captcha_session_id=default_recaptcha_id_'.$role.'_login') }}";
