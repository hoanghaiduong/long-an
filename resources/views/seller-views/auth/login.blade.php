                                ...
                                <div class="row py-2">
                                    <div class="col-6 pr-0">
                                        <input type="text" class="form-control __h-40" name="default_recaptcha_id_seller_login" value=""
                                            placeholder="{{translate('enter_captcha_value')}}" class="border-0" autocomplete="off">
                                    </div>
...
@else
    <script type="text/javascript">
        function re_captcha() {
            ...
            $url = $url + "/" + randomNumber+'?captcha_session_id=default_recaptcha_id_seller_login';
...
@if(env('APP_MODE')=='demo')
    <script>
        function copy_cred() {
            ...
            toastr.success('{{translate("copied_successfully")}}!', 'Success!', {
                CloseButton: true,
                ProgressBar: true
            });
        }
