                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <!-- End Dashboards -->
                         ...
                         <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/pos*') && !Request::is('admin/posts*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        <!-- End POS -->
      <!-- Posts -->
      @if (\App\CPU\Helpers::module_permission_check('posts_management'))
      <li class="nav-item {{(Request::is('admin/posts*'))?'scroll-here':''}}">
          <small class="nav-subtitle"
              title="">{{translate('posts_management')}}</small>
          <small class="tio-more-horizontal nav-subtitle-replacer"></small>
      </li>
      <li class="navbar-vertical-aside-has-menu {{Request::is('admin/posts*') ?'active':''}}">
          <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
          href="javascript:" title="{{translate('posts')}}">
          ...
          <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
              style="display: {{(Request::is('admin/posts*'))?'block':''}}">
              <li class="nav-item {{Request::is('admin/posts/add-new')?'active':''}}">
                  <a class="nav-link " href="{{route('admin.posts.add-new')}}"
                     title="{{translate('add_posts')}}">
                      <span class="tio-circle nav-indicator-icon"></span>
                      <span class="text-truncate">{{translate('add_posts')}}</span>
                  </a>
              </li>
              <li class="nav-item {{Request::is('admin/posts/list')?'active':''}}">
                  <a class="nav-link " href="{{route('admin.posts.list')}}"
                     title="{{translate('list_posts')}}">
                      <span class="tio-circle nav-indicator-icon"></span>
                      <span class="text-truncate">{{translate('list_posts')}}</span>
                  </a>
              </li>
            
              <li class="nav-item {{Request::is('admin/posts/post-type/view')?'active':''}}">
                  <a class="nav-link " href="{{route('admin.posts.view_post_type')}}"
                     title="{{translate('add_post_type')}}">
                      <span class="tio-circle nav-indicator-icon"></span>
                      <span class="text-truncate">{{translate('add_post_type')}}</span>
                  </a>
              </li>
