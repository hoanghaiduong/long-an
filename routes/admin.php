...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'posts', 'as' => 'posts.', 'middleware' => ['module:posts_management']], function () {
            Route::get('list', 'PostController@list')->name('list');
            Route::get('add-new', 'PostController@add_new')->name('add-new');
            Route::get('view/{id}', 'PostController@view')->name('view');
            Route::get('edit/{id}', 'PostController@edit')->name('edit');
            // Route::get('get-categories', 'PostController@get_categories')->name('get-categories');
            Route::post('store', 'PostController@store')->name('store');
            Route::post('update/{id}', 'PostController@update')->name('update');
            Route::get('export-excel', 'PostController@export_excel')->name('export-excel');
            Route::get('/post-type', 'PostController@view_post_type')->name('view_post_type');
            // Route::get('/post-type/add-new', 'PostController@add_new_post_type')->name('add-new-post-type');
            Route::post('/post-type/store', 'PostController@post_type_store')->name('post_type_store');
            Route::get('/post-type/update/{id}', 'PostController@post_type_edit')->name('post_type_edit');
            Route::post('/post-type/update/{id}', 'PostController@post_type_update')->name('post_type_update');
        });
        ...
        Route::group(['prefix' => 'coupon', 'as' => 'coupon.', 'middleware' => ['module:promotion_management']], function () {
            ...
            Route::get('export', 'CouponController@export')->name('export')->middleware('actch');
        ...
        Route::group(['prefix' => 'notification', 'as' => 'notification.', 'middleware' => ['module:promotion_management']], function () {
            ...
            Route::post('update-push-notification', 'NotificationController@update_push_notification')->name('update-push-notification');
        });
        ...
        Route::group(['prefix' => 'customer', 'as' => 'customer.', 'middleware' => ['module:user_section']], function () {
            ...
            Route::group(['prefix' => 'wallet', 'as' => 'wallet.'], function () {
                ...
                Route::get('bonus-setup', 'CustomerWalletController@bonus_setup')->name('bonus-setup');
                Route::post('bonus-setup-store', 'CustomerWalletController@bonus_setup_store')->name('bonus-setup-store');
                Route::post('bonus-setup-update', 'CustomerWalletController@bonus_setup_update')->name('bonus-setup-update');
                Route::post('bonus-setup-status', 'CustomerWalletController@bonus_setup_status')->name('bonus-setup-status');
                Route::get('bonus-setup/edit/{id}', 'CustomerWalletController@bonus_setup_edit')->name('bonus-setup-edit');
                Route::delete('bonus-setup-delete', 'CustomerWalletController@bonus_setup_delete')->name('bonus-setup-delete');
            });
            Route::group(['prefix' => 'loyalty', 'as' => 'loyalty.'], function () {
                Route::get('report', 'CustomerLoyaltyController@report')->name('report');
                Route::get('export', 'CustomerLoyaltyController@export')->name('export');
            });
        });
        ...
        Route::group(['prefix' => 'refund-section', 'as' => 'refund-section.', 'middleware' => ['module:order_management']], function () {
            ...
            Route::group(['prefix' => 'refund', 'as' => 'refund.'], function () {
                ...
                Route::get('export/{status}', 'RefundController@export')->name('export');
        ...
        Route::group(['prefix' => 'transaction', 'as' => 'transaction.', 'middleware' => ['module:report']], function () {
            ...
            Route::get('wallet-bonus', 'TransactionReportController@wallet_bonus')->name('wallet-bonus');
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
            ...
            Route::group(['prefix' => 'web-config', 'as' => 'web-config.', 'middleware' => ['module:system_settings']], function () {
                ...
                Route::post('app-settings/update', 'BusinessSettingsController@app_settings_update')->name('app-settings-update');
                ...
                Route::get('login-url-setup', 'BusinessSettingsController@login_url_setup')->name('login-url-setup');
                Route::post('login-url-setup-post', 'BusinessSettingsController@login_url_setup_post')->name('login-url-setup-post');
                ...
                Route::group(['prefix' => 'theme', 'as' => 'theme.'], function () {
                    ...
                    Route::post('notify-all-the-sellers', 'ThemeController@notify_all_the_sellers')->name('notify-all-the-sellers');
                });
            });
            ...
            Route::group(['prefix' => 'payment-method', 'as' => 'payment-method.', 'middleware' => ['module:system_settings']], function () {
                ...
                Route::get('/offline-payment', 'OfflinePaymentMethodController@index')->name('offline')->middleware('actch');
                Route::get('/offline-payment/new', 'OfflinePaymentMethodController@create')->name('offline.new')->middleware('actch');
                Route::post('/offline-payment/store', 'OfflinePaymentMethodController@store')->name('offline.store')->middleware('actch');
                Route::get('/offline-payment/edit/{id}', 'OfflinePaymentMethodController@edit')->name('offline.edit')->middleware('actch');
                Route::post('/offline-payment/update', 'OfflinePaymentMethodController@update')->name('offline.update')->middleware('actch');
                Route::post('/offline-payment/delete', 'OfflinePaymentMethodController@delete')->name('offline.delete')->middleware('actch');
            ...
            Route::group(['middleware' => ['module:system_settings']], function () {
                ...
                Route::get('company-reliability', 'BusinessSettingsController@company_reliability')->name('company-reliability');
                Route::post('company-reliability/store', 'BusinessSettingsController@company_reliability_store')->name('company-reliability.store');
            });
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.', 'middleware' => ['module:order_management']], function () {
            ...
            Route::post('address-update', 'OrderController@address_update')->name('address-update'); // update address from order details
        ...
        Route::group(['prefix' => 'pos', 'as' => 'pos.', 'middleware' => ['module:pos_management']], function () {
            ...
            Route::post('customer-update', 'POSController@customer_update')->name('customer-update');
            Route::post('view-all-hold-orders', 'POSController@view_all_hold_orders')->name('view-all-hold-orders');
        ...
        Route::group(['prefix' => 'delivery-man', 'as' => 'delivery-man.', 'middleware' => ['module:user_section']], function () {
            ...
            Route::get('order-history-log-export/{id}', 'DeliveryManController@order_history_log_export')->name('order-history-log-export');
...
Route::group(['namespace' => 'ThemeFeatures', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'most-demanded', 'as' => 'most-demanded.', 'middleware' => ['module:promotion_management']], function () {
            ...
            Route::post('/upddate/{id}', 'MostDemandedController@update')->name('update');
            Route::post('delete', 'MostDemandedController@delete')->name('delete');
            Route::post('/status-update', 'MostDemandedController@status_update')->name('status-update');
        });

        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
            Route::get('all-pages-banner', 'AllPagesBannerController@all_pages_banner')->name('all-pages-banner');
            Route::post('all-pages-banner-store', 'AllPagesBannerController@all_pages_banner_store')->name('all-pages-banner-store');
            Route::get('all-pages-banner-edit/{id}', 'AllPagesBannerController@all_pages_banner_edit')->name('all-pages-banner-edit');
            Route::post('all-pages-banner-update', 'AllPagesBannerController@all_pages_banner_update')->name('all-pages-banner-update');
            Route::post('all-pages-banner-status', 'AllPagesBannerController@all_pages_banner_status')->name('all-pages-banner-status');
            Route::post('all-pages-banner-delete', 'AllPagesBannerController@all_pages_banner_delete')->name('all-pages-banner-delete');
        });
    });
});
