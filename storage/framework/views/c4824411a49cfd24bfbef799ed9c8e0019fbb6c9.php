...
<?php $__env->startSection('content'); ?>
    <div class="content container-fluid">
        ...
        <!-- Form -->
        <form class="product-form text-start" action="<?php echo e(route('admin.product.store')); ?>" method="POST" enctype="multipart/form-data" id="product_form">
            <?php echo csrf_field(); ?>
            <div class="card">
                <div class="px-4 pt-3">
                    ...
                    <?php $__currentLoopData = json_decode($language); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="<?php echo e($lang != $default_lang ? 'd-none' : ''); ?> lang_form"
                            ...
                            <div class="form-group pt-4">
                                ...
                                <textarea name="description[]" class="textarea editor-textarea"><?php echo e(old('details')); ?></textarea>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                    ...
                    <div class="row">
                                ...
                                <select class="js-select2-custom form-control" name="category_id"
                                    ...
                                    <?php $__currentLoopData = $cat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($c['id']); ?>"
                                            <?php echo e(old('name') == $c['id'] ? 'selected' : ''); ?>>
                                            <?php echo e($c['defaultName']); ?>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control" name="sub_category_id"
                                        ...
                                        <option value="<?php echo e(null); ?>" selected disabled><?php echo e(translate('select_Sub_Category')); ?></option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control" name="sub_sub_category_id"
                                        ...
                                        <option value="<?php echo e(null); ?>" selected disabled><?php echo e(translate('select_Sub_Sub_Category')); ?></option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    ...
                                    <select class="js-select2-custom form-control" name="brand_id" required>
                                        <option value="<?php echo e(null); ?>" selected disabled><?php echo e(translate('select_Brand')); ?></option>
                                        <?php $__currentLoopData = $br; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($b['id']); ?>"><?php echo e($b['defaultName']); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3" id="digital_product_type_show">
                            <div class="form-group">
                                ...
                                <select name="digital_product_type" id="digital_product_type" class="form-control" required>
                                    <option value="<?php echo e(old('category_id')); ?>" selected disabled>---<?php echo e(translate('select')); ?>---</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                      ...
                                      <label class="custom-file-label" for="inputGroupFile01"><?php echo e(translate('choose_file')); ?></label>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" minlength="6" id="generate_number" name="code"
                                        ...
                                        placeholder="<?php echo e(translate('code')); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="<?php echo e(translate('enter_tag')); ?>" name="tags" data-role="tagsinput">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <div class="d-flex gap-2 mb-2">
                                    <label class="title-color mb-0"><?php echo e(translate('purchase_price')); ?> (<?php echo e(\App\CPU\BackEndHelper::currency_symbol()); ?>)</label>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <div class="d-flex gap-2 mb-2">
                                    <label class="title-color mb-0"><?php echo e(translate('unit_price')); ?> (<?php echo e(\App\CPU\BackEndHelper::currency_symbol()); ?>)</label>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3" id="minimum_order_qty">
                            <div class="form-group">
                                <div class="d-flex gap-2 mb-2">
                                    <label class="title-color mb-0" for="minimum_order_qty"><?php echo e(translate('minimum_order_qty')); ?></label>
                                ...
                                <input type="number" min="1" value="1" step="1" placeholder="<?php echo e(translate('minimum_order_quantity')); ?>" name="minimum_order_qty" id="minimum_order_qty" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show" id="quantity">
                            <div class="form-group">
                                <div class="d-flex gap-2 mb-2">
                                    <label class="title-color mb-0" for="current_stock"><?php echo e(translate('current_stock_qty')); ?></label>
                                ...
                                <input type="number" min="0" value="0" step="1" placeholder="<?php echo e(translate('quantity')); ?>" name="current_stock" id="current_stock" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <div class="d-flex gap-2 mb-2">
                                    <label class="title-color mb-0" for="discount_Type"><?php echo e(translate('discount_Type')); ?></label>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <div class="d-flex gap-2">
                                    <label class="title-color" for="discount"><?php echo e(translate('discount_amount')); ?> <span class="discount_amount_symbol">(<?php echo e(\App\CPU\BackEndHelper::currency_symbol()); ?>)</span></label>
                                ...
                                <input type="number" min="0" value="0" step="0.01" placeholder="<?php echo e(translate('ex: 5')); ?>"
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" value="0" step="0.01"
                                        ...
                                        value="<?php echo e(old('tax')); ?>" class="form-control">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show" id="shipping_cost">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" value="0" step="1" placeholder="<?php echo e(translate('shipping_cost')); ?>" name="shipping_cost" class="form-control" required>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-end">
                        <div class="col-md-6">
                            <div class="mb-3 d-flex align-items-center gap-2">
                                ...
                                <label class="switcher">
                                    <input type="checkbox" class="switcher_input" id="color_switcher" value="<?php echo e(old('colors_active')); ?>"
                                            name="colors_active">
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                                ...
                                <div class="form-group">
                                    <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                                        <div>
                                            ...
                                            <span class="input-label-secondary cursor-pointer" data-toggle="tooltip" title="<?php echo e(translate('add_your_product’s_thumbnail_in')); ?> JPG, PNG or JPEG <?php echo e(translate('format_within')); ?> 2MB">
                                                <img src="<?php echo e(asset('/public/assets/back-end/img/info-circle.svg')); ?>" alt="">
                                            </span>
                                        </div>
                                    </div>
            ...
            <div class="card mt-3 rest-part">
                ...
                <div class="card-body">
                    ...
                    <input type="text" name="video_link" placeholder="<?php echo e(translate('ex')); ?> : https://www.youtube.com/embed/5R06LRdUCSE" class="form-control" required>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="meta_title" placeholder="<?php echo e(translate('meta_Title')); ?>" class="form-control">
                            </div>
                            <div class="form-group">
                                <label class="title-color">
            ...
            <div class="row justify-content-end gap-3 mt-3 mx-1">
                ...
                <button type="button" onclick="check()" class="btn btn--primary px-5"><?php echo e(translate('submit')); ?></button>
            </div>
        </form>
    </div>
    ...
    <script>
        ...
        function add_more_customer_choice_option(i, name) {
            ...
            $('#customer_choice_options').append(
                ...
                '" hidden><div class=""><input type="text" class="form-control" name="choice_options_' + i + '[]" placeholder="<?php echo e(translate('enter_choice_values')); ?>" data-role="tagsinput" onchange="update_sku()"></div></div></div>'
            );
        ...
        $('#colors-selector').on('change', function() {
            ...
            $('.remove_button').on('click',function(){
                alert('ok');
                $(this).parents('.upload_images').find('.color_image').attr('src','<?php echo e(asset('public/assets/back-end/img/400x400/img2.jpg')); ?>')
            })
        });
                        ...
                        $.post({
                            ...
                            success: function (data) {
                                if (data.errors) {
                                    ...
                                    toastr.success(
                                        '<?php echo e(translate("product_added_successfully")); ?>!', {
                                            CloseButton: true,
                                            ProgressBar: true
                                        });
                                    $('#product_form').submit();
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\long-an\resources\views/admin-views/product/add-new.blade.php ENDPATH**/ ?>