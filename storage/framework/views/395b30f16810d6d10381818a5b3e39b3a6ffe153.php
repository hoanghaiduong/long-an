    ...
    <div class="card mt-4">
        <div class="p-4 my-md-3 mx-xl-4 px-md-5">
            ...
            <div class="text-center">
                ...
                <a href="<?php echo e(route('step1')); ?>" class="btn btn-dark px-sm-5">
                    Get Started</a>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.blank', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\long-an\resources\views/installation/step0.blade.php ENDPATH**/ ?>