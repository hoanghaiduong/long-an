        ...
        <div class="navbar navbar-expand-md navbar-light">
            <div class="container ">
                ...
                <div class="input-group-overlay mx-lg-4 search-form-mobile"
                     style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>">
                     <div style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'left' : 'right'); ?>" class="d-lg-none">
                ...
                <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center">
                    ...
                    <?php if(auth('customer')->check()): ?>
                        <div class="dropdown">
                            <a class="navbar-tool ml-3" type="button" data-toggle="dropdown" aria-haspopup="true"
                               aria-expanded="false">
                                <div class="navbar-tool-icon-box bg-secondary">
                                    <div class="navbar-tool-icon-box bg-secondary">
                                        <img  src="<?php echo e(asset('storage/app/public/profile/'.auth('customer')->user()->image)); ?>"
                                             onerror="this.src='<?php echo e(asset('public/assets/front-end/img/user.png')); ?>'"
                            ...
                            <div class="dropdown-menu dropdown-menu-<?php echo e(Session::get('direction') === "rtl" ? 'left' : 'right'); ?>" aria-labelledby="dropdownMenuButton">
                    ...
                    <?php else: ?>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu __auth-dropdown dropdown-menu-<?php echo e(Session::get('direction') === "rtl" ? 'left' : 'right'); ?>" aria-labelledby="dropdownMenuButton"
                                 style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;">
                                <a class="dropdown-item" href="<?php echo e(route('customer.auth.login')); ?>">
                                    <i class="fa fa-sign-in <?php echo e(Session::get('direction') === "rtl" ? 'mr-2' : 'mr-2'); ?>"></i> <?php echo e(translate('sign_in')); ?>

                                </a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="<?php echo e(route('customer.auth.sign-up')); ?>">
                                    <i class="fa fa-user-circle <?php echo e(Session::get('direction') === "rtl" ? 'mr-2' : 'mr-2'); ?>"></i><?php echo e(translate('sign_up')); ?>
        ...
        <div class="navbar navbar-expand-md navbar-stuck-menu"  >
            <div class="container px-10px">
                <div class="collapse navbar-collapse" id="navbarCollapse"
                    style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>; ">
                    <div class="w-100 d-md-none" style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'left' : 'right'); ?>;">
                    ...
                    <ul class="navbar-nav mega-nav pr-lg-2 pl-lg-2 <?php echo e(Session::get('direction') === "rtl" ? 'mr-2' : 'mr-2'); ?> d-none d-md-block __mega-nav">
                        <li class="nav-item <?php echo e(!request()->is('/')?'dropdown':''); ?>">

                            <a class="nav-link dropdown-toggle category-menu-toggle-btn <?php echo e(Session::get('direction') === "rtl" ? 'pr-0' : 'pl-0'); ?>"
                        ...
                        <li class="nav-item dropdown d-md-none">
                            <a class="nav-link dropdown-toggle <?php echo e(Session::get('direction') === "rtl" ? 'pr-0' : 'pl-0'); ?>"
                               href="javascript:void()" data-toggle="dropdown">
                                ...
                                <span
                                    style="margin-<?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>: 20px;"><?php echo e(translate('categories')); ?></span>
                            </a>
                    ...
                    <ul class="navbar-nav" style="<?php echo e(Session::get('direction') === "rtl" ? 'padding-right: 0px' : ''); ?>">
                        ...
                        <?php if(\App\Model\BusinessSetting::where(['type'=>'product_brand'])->first()->value): ?>
                        ...
                        <?php if($discount_product>0): ?>
                            <li class="nav-item dropdown <?php echo e(request()->is('/')?'active':''); ?>">
                                <a class="nav-link text-capitalize" href="<?php echo e(route('products',['data_from'=>'discounted','page'=>1])); ?>"><?php echo e(translate('discounted_products')); ?></a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if($business_mode == 'multi'): ?>
                            <li class="nav-item dropdown <?php echo e(request()->is('/')?'active':''); ?>">
                                <a class="nav-link text-capitalize" href="<?php echo e(route('sellers')); ?>"><?php echo e(translate('all_sellers')); ?></a>
                            </li>
                        <?php endif; ?>
                                ...
                                <li class="nav-item">
                                    <div class="dropdown">
                                        <button class="btn dropdown-toggle text-white text-max-md-dark text-capitalize" type="button" id="dropdownMenuButton"
                                                ...
                                                style="padding-<?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>: .5rem">
                                            <?php echo e(translate('seller_zone')); ?>
                                        ...
                                        <div class="dropdown-menu __dropdown-menu-3 __min-w-165px" aria-labelledby="dropdownMenuButton"
                                            ...
                                            <a class="dropdown-item" href="<?php echo e(route('shop.apply')); ?>">
                                                <?php echo e(translate('become_a_seller')); ?>

                                            </a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="<?php echo e(route('seller.auth.login')); ?>">
                                                <?php echo e(translate('seller_login')); ?>
                        ...
                        <li class="nav-item dropdown <?php echo e(request()->is('/')?'active':''); ?>">
                            <a class="nav-link text-capitalize" href="<?php echo e(route('posts')); ?>"><?php echo e(translate('posts')); ?></a>
                        </li>
            ...
            <div class="container">
                <div class="category-menu-wrap">
                    <ul class="category-menu">
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <li class="text-center"><a href="<?php echo e(route('categories')); ?>" class="text-primary font-weight-bold justify-content-center">View All</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<?php $__env->startPush('script'); ?>
    <script>
        ...
        $(".category-menu").find(".mega_menu").parents("li").addClass("has-sub-item").find("> a").append("<i class='czi-arrow-<?php echo e(Session::get('direction') === "rtl" ? 'left' : 'right'); ?>'></i>");
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\long-an\resources\themes\default/layouts/front-end/partials/_header.blade.php ENDPATH**/ ?>