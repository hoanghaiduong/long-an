        ...
        <div class="modal-content shadow-lg">
            ...
            <div class="modal-body px-4 px-sm-5 pt-0">
                ...
                <div class="d-flex justify-content-center gap-3">
                    <button type="button" class="btn btn--primary min-w-120" data-dismiss="modal" id="toggle-ok-button" onclick="confirmToggle()"><?php echo e(translate('ok')); ?></button>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg">
            ...
            <div class="modal-body px-4 px-sm-5 pt-0">
                ...
                <div class="d-flex justify-content-center gap-3">
                    <button type="button" class="btn btn--primary min-w-120" data-dismiss="modal" id="toggle-status-ok-button" onclick="confirmStatusToggle()"><?php echo e(translate('ok')); ?></button>
                    <button type="button" class="btn btn-danger-light min-w-120" data-dismiss="modal"><?php echo e(translate('cancel')); ?></button>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\long-an\resources\views/layouts/back-end/partials/_toggle-modal.blade.php ENDPATH**/ ?>