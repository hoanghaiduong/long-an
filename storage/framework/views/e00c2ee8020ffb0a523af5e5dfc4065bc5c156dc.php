        ...
        <div class="col-xl-3 position-static d-none d-xl-block __top-slider-cate">
            <div class="category-menu-wrap position-static">
                <ul class="category-menu mt-0">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <li class="text-center"><a href="<?php echo e(route('categories')); ?>" class="text-primary font-weight-bold justify-content-center text-capitalize"><?php echo e(translate('view_all')); ?></a></li>
                </ul>
            </div>
        </div>
    <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\long-an\resources\themes\default/web-views/partials/_home-top-slider.blade.php ENDPATH**/ ?>