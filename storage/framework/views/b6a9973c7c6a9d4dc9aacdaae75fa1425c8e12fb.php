        ...
        <div class="__p-20px rounded bg-white overflow-hidden">
            <div class="d-flex __gap-6px flex-between px-sm-3">
                ...
                <div class="category-product-view-all">
                    <a class="text-capitalize view-all-text text-nowrap" style="color: <?php echo e($web_config['primary_color']); ?>!important"
                    href="<?php echo e(route('products',['id'=> $category['id'],'data_from'=>'category','page'=>1])); ?>"><?php echo e(translate('view_all')); ?>
...
<?php /**PATH C:\xampp\htdocs\long-an\resources\themes\default/web-views/partials/_category-wise-product.blade.php ENDPATH**/ ?>