    ...
    <div class="card mt-4">
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            ...
            <div class="d-flex align-items-center column-gap-3 flex-wrap">
                ...
                <h5 class="fw-normal">Update Purchase Information | <a href="https://cutt.ly/PLFZenO" target="_blank">NULLED :: Web Community</a></h5>
            </div>
...
<?php echo $__env->make('layouts.blank', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\long-an\resources\views/installation/step2.blade.php ENDPATH**/ ?>