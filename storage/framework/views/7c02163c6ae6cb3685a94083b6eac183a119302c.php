			...
			ClassicEditor
				.create( document.querySelector( '#editor2' ), {
					ckfinder: {
						...
						uploadUrl: '<?php echo e(route('ckfinder_connector')); ?>?command=QuickUpload&type=Files&responseType=json'
					},
...
<?php echo $__env->make('ckfinder::samples/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\long-an\vendor\ckfinder\ckfinder-laravel-package\src/../views/samples/ckeditor.blade.php ENDPATH**/ ?>