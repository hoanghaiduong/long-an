        ...
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
                ...
                <div class="px-xl-2 pb-sm-3">
                    <div class="row g-4 g-md-5">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex gap-3 align-items-center">
                                <img
                                    src="<?php echo e(asset('public/assets/installation')); ?>/assets/img/svg-icons/route-service.svg"
                                    alt="">
                                <div
                                    class="d-flex align-items-center gap-2 justify-content-between flex-grow-1">
                                    .env File Permission
            ...
            <div class="text-center">
                ...
                <?php if($permission['curl_enabled'] == 1 && $permission['db_file_write_perm'] == 1 && $permission['routes_file_write_perm'] == 1 && $phpVersion >= 8.0): ?>
                    <a href="<?php echo e(route('step2')); ?>" class="btn btn-dark px-sm-5">Proceed
                        Next</a>
                <?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.blank', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\long-an\resources\views/installation/step1.blade.php ENDPATH**/ ?>