                                ...
                                <div class="row p-2">
                                    ...
                                    <div class="col-6 input-icons" class="bg-white rounded">
                                        <a onclick="javascript:re_captcha();">
                                            <img src="<?php echo e(URL('/auth/captcha/'.rand().'?captcha_session_id=default_recaptcha_id_'.$role.'_login')); ?>" class="input-field w-90 h-75" id="default_recaptcha_id">
...
<?php else: ?>
    ...
    <script type="text/javascript">
        var captchaURL = "<?php echo e(URL('/auth/captcha/'.rand().'?captcha_session_id=default_recaptcha_id_'.$role.'_login')); ?>";
    
        function re_captcha() {
            var newURL = captchaURL + "&rand=" + Math.random();
            document.getElementById('default_recaptcha_id').src = newURL;
...
<?php /**PATH C:\xampp\htdocs\long-an\resources\views/admin-views/auth/login.blade.php ENDPATH**/ ?>